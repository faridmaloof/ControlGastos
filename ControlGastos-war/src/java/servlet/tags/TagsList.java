 ...
 * @author farid
 */
@WebServlet(name = "TagsList", urlPatterns = {"/TagsList"})
public class TagsList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {                    
            ...
            List<Entities.Tag> elements = dao.getAll();
            for(Entities.Tag element: elements) {
                String esActivo;
                if (element.getActivo()) {
                    esActivo = "<a href=\"TagsUpdate?element="+element.getId()+"\" class=\"btn btn-info\" data-toggle=\"tooltip\" data-original-title=\"edit\">\n" +
"                                                              <i class=\"material-icons opacity-10\">edit</i>\n" +
"                                                            </a>\n" +
"                                                            <a href=\"TagsInactivate?element="+element.getId()+"\" class=\"btn btn-danger\" data-toggle=\"tooltip\" data-original-title=\"disabled\">\n" +
"                                                              <i class=\"material-icons opacity-10\">delete</i>\n" +
"                                                            </a>";
                } else {
                    esActivo = "<a href=\"TagsActivate?element="+element.getId()+"\" class=\"btn btn-success\" data-toggle=\"tooltip\" data-original-title=\"enabled\">\n" +
...
"                    </tr>";
            ...
            out.println(helpers.Templates.ListElements("Tags", table, alerts, "TagsCreate"));
        }    
    }
