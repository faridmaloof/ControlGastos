 ...
 * @author farid
 */
@WebServlet(name = "TercerosUpdate", urlPatterns = {"/TercerosUpdate"})
public class TercerosUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Entities.Tercero element = dao.getById(Integer.parseInt(request.getParameter("element")));
...
"                            <input type=\"text\" class=\"form-control\" name=\"uid\" value=\""+element.getNumeroIdentificacion()+"\" maxlength=\"15\" required>\n" +
"                        </div>\n" +
"                        <div class=\"input-group input-group-outline mb-3 is-filled\">\n" +
"                            <label class=\"form-label\">Nombre</label>\n" +
"                            <input type=\"text\" class=\"form-control\" name=\"nombre\" value=\""+element.getNombre()+"\" maxlength=\"100\" required>\n" +
"                        </div>\n" +
