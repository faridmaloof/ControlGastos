        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Depositos_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrosGastos_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PresupuestosMensuales_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PresupuestosMensuales_TiposGastos_TipoGastoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrosGastosDetalles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistrosGastosDetalles_RegistrosGastos_RegistroGastoId",
                        column: x => x.RegistroGastoId,
                        principalTable: "RegistrosGastos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistrosGastosDetalles_TiposGastos_TipoGastoId",
                        column: x => x.TipoGastoId,
                        principalTable: "TiposGastos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PresupuestosMensuales_TipoGastoId",
                table: "PresupuestosMensuales",
                column: "TipoGastoId");

            migrationBuilder.CreateIndex(
                name: "IX_PresupuestosMensuales_UsuarioId",
                table: "PresupuestosMensuales",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrosGastosDetalles_RegistroGastoId",
                table: "RegistrosGastosDetalles",
                column: "RegistroGastoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrosGastosDetalles_TipoGastoId",
                table: "RegistrosGastosDetalles",
                column: "TipoGastoId");

            migrationBuilder.CreateIndex(
                name: "IX_TiposGastos_Codigo",
                table: "TiposGastos",
                column: "Codigo",
                unique: true);
        }
